...
@Component({
  selector: 'app-human-woman-full',
  imports: [CommonModule],
  templateUrl: './human-woman-full.component.html',
  styleUrl: './human-woman-full.component.scss',
  standalone: true,
})
export class HumanWomanFullComponent {
  ...
  @ViewChild('womanSvg') womanSvg!: ElementRef<SVGElement>
  public viewBox = '0 0 218 500'

  humanSex = signal<string>('Feminino')
